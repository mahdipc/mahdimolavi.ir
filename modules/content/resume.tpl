        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <div class="section-title">
                    ...
                    <p class="text-muted mx-auto para-desc mb-0">I am a researcher in the field of artificial
                        intelligence with the following education.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="event event-description-right rounded p-4 border float-left text-left">
                                    <h5 class="title mb-0 text-capitalize">Tarbiat Modares University</h5>
                                    <small class="company">Master's degree, Computer Science</small>
                                    <p class="timeline-subtitle mt-3 mb-0 text-muted">
                                        Tarbiat Modares University is an exclusively graduate university with its main
                                        campus in Tehran, Iran. It was founded in 1982 and is consistently ranked among
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 order-sm-1 order-2">
                                <div class="event event-description-left rounded p-4 border float-left text-right">
                                    <h5 class="title mb-0 text-capitalize">Urmia University</h5>
                                    <small class="company">Bachelor's degree, Applied Mathematics</small>
                                    <p class="timeline-subtitle mt-3 mb-0 text-muted">
                                        Urmia University is a higher education company based out of West Azerbaijan,
                                        Iran.
                                    </p>
                                </div>
                            </div>
...
<section class="cta-full border-top">
    <div class="container-fluid">
        <div class="row position-relative">
            <div class="col-lg-4 padding-less img" style="background-image:url('{THEME}/images/bigdatalearning.webp')"
                        ...
                        <div class="col-12 text-center">
                            <div class="section-title">
                                ...
                                <p class="text-muted mx-auto para-desc mb-0">
                                    I believe that a science and technology is not complete, so the given percentages
                                    are given in relative terms.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-5 col-12">
                            <ul class="nav nav-pills flex-column px-0" id="pills-tab" role="tablist">
                                <li class="nav-item mt-4 pt-2">
                                    <a class="nav-link rounded active" id="pills-AI-tab" data-toggle="pill"
                                        href="#pills-AI" role="tab" aria-controls="pills-AI" aria-selected="false">
                                        <div class="skill-container text-center pt-1 pb-1">
                                            <h6 class="title mb-0">AI</h6>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item mt-4 pt-2">
                                    <a class="nav-link rounded" id="pills-Computational-tab" data-toggle="pill"
                                        href="#pills-Computational" role="tab" aria-controls="pills-Computational"
                                        aria-selected="false">
                                        <div class="skill-container text-center pt-1 pb-1">
                                            <h6 class="title mb-0">Computational programming languages</h6>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item mt-4 pt-2">
                                    <a class="nav-link rounded" id="pills-language-tab" data-toggle="pill"
                                        href="#pills-language" role="tab" aria-controls="pills-language"
                                        aria-selected="false">
                                        <div class="skill-container text-center pt-1 pb-1">
                                ...
                                <li class="nav-item mt-4 pt-2">
                                    <a class="nav-link rounded" id="pills-development-tab" data-toggle="pill"
                        ...
                        <div class="col-lg-8 col-md-7 col-12">
                            <div class="tab-content pl-lg-4" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-AI" role="tabpanel"
                                    aria-labelledby="pills-AI-tab">
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Tensor Decompose</h6>
                                        <div class="progress">
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Tensor Product</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:95%;">
                                                <div class="progress-value d-block text-dark h6">95%</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Big Data</h6>
                                        <div class="progress">
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Classification and clustering method</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:90%;">
                                                <div class="progress-value d-block text-dark h6">90%</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Deep learning and Neural network</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:60%;">
                                                <div class="progress-value d-block text-dark h6">60%</div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-Computational" role="tabpanel"
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Matlab</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:90%;">
                                                <div class="progress-value d-block text-dark h6">90%</div>
                                            </div>
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Mathematica </h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:100%;">
                                                <div class="progress-value d-block text-dark h6">100%</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Julia </h6>
                                        <div class="progress">
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">C and C++ </h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:60%;">
                                                <div class="progress-value d-block text-dark h6">60%</div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-language" role="tabpanel"
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Farsi</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:100%;">
                                                <div class="progress-value d-block text-dark h6">100%</div>
                                            </div>
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Azerbaijani </h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:100%;">
                                                <div class="progress-value d-block text-dark h6">100%</div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-development" role="tabpanel"
                                    ...
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">.Net family</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:85%;">
                                                <div class="progress-value d-block text-dark h6">85%</div>
                                            </div>
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">PHP</h6>
                                        <div class="progress">
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">JavaScript library(Native,React,Vue,...)
                                        </h6>
                                        <div class="progress">
                                    ...
                                    <!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Lua
                                        </h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:40%;">
                                                <div class="progress-value d-block text-dark h6">40%</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end process box-->
